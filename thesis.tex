...
% arara: pdflatex
% arara: pdflatex
% arara: texcount: {options:['-inc'], html:yes, output: word_count.html }
% arara: clean: { extensions: [ aux, log, bcf, blg, mw, out, xml,toc, glo, hd, idx, gz, lof, lot, fls, upa,dep,bbl-SAVE-ERROR] }
...
\usepackage[a4paper,top=25.4mm,bottom=25.4mm,left=38mm, right=19mm,bindingoffset=0mm]{geometry} %This package resizes the margins to meet La Trobe's guidelines https://policies.latrobe.edu.au/download.php?id=80&version=15&associated
